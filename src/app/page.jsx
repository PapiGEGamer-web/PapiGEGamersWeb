      ...
      <header
        ...
        <div className="container mx-auto flex justify-between items-center">
          <Link href="#" className="flex items-center gap-2" prefetch={false}>
            ...
            <span className="text-lg font-semibold animate-pulse text-primary">PapiGEGamer</span>
          </Link>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            <Card className="max-w-[400px] hover:scale-105 duration-300">
              ...
              <CardFooter className="flex justify-end">
                <Link
                  href="https://cdn.discordapp.com/avatars/979165049258143777/d0107a00f718473260af2f86e576bc09.webp?size=4096"
